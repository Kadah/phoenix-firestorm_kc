...
time autobuild configure -A 64 -c ReleaseFS_open -- -DPACKAGE:BOOL=On --chan="KC" --fmodstudio  -DUSE_JASPER:BOOL=On -DUSE_SDL2:BOOL=On --clean

time autobuild build -A 64 -c ReleaseFS_open -- -DPACKAGE:BOOL=On --chan="KC" --fmodstudio  -DUSE_JASPER:BOOL=On -DUSE_SDL2:BOOL=On
